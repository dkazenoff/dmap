"""
Django settings for sddproject project.
...
SECRET_KEY = '*a!sd^ar8_zx3#14tb7wo1udi--ynnhz#cqd08*q80_#kox)wx'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'sublet/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sddproject.wsgi.application'
